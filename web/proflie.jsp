...
<body>
    ...
    <div class="middle-main">
        ...
        <div class="tab">
            <div class="tab_bar">
                <div class="tab_bar_row">推文</div>
                <div class="tab_bar_row">推文和回复</div>
                <div class="tab_bar_row">媒体</div>
                <div class="tab_bar_row">喜欢</div>
            </div>
            <div class="section" style="display: block;">
                <div class="Tutter">
                    <div class="Tutter_main">
                        ...
                        <div class="Tutter_main_content">
                            ...
                            <p class="user_content">网抑云 呜呜呜呜呜呜呜</p>
                            <div class="Media">
                                <video src="./video/QQ视频20200928180226.mp4" controls="controls"
                                    style="width: 495px;"></video>
                            </div>
                            <div class="controls">
                                <div class="controls_icon">
                                    <div class="controls_icon_hover"><img id="comments"
                                            src="./images/icon/黑 icon/评论.png" alt=""></div>
                                    <span>158</span>
                                </div>
                                <div class="controls_icon">
                                ...
                                <div class="controls_icon">
                                    <div class="controls_icon_hover"><img id="download"
                                            src="./images/icon/黑 icon/下载.png" alt=""></div>
                                    <span>30</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="Tutter">
                    <div class="Tutter_main">
                        ...
                        <div class="Tutter_main_content">
                            <p class="userName">陈子辉</p>
                            <p class="user_content">今天阿伟来我家van了 好开心QVQ</p>
                            <div class="Media">
                                <img src="./images/Avatar/OIP.jpg" alt="">
                            </div>
                            <div class="controls">
                                <div class="controls_icon">
                                    <div class="controls_icon_hover"><img src="./images/icon/黑 icon/评论.png" alt="">
                                    </div>
                                    <span>111</span>
                                </div>
                                <div class="controls_icon">
                                    <div class="controls_icon_hover"><img src="./images/icon/黑 icon/转发.png" alt="">
                                    </div>
                                    <span>111</span>
                                </div>
                                <div class="controls_icon">
                                    <div class="controls_icon_hover"><img src="./images/icon/黑 icon/喜欢.png" alt="">
                                    </div>
                                    <span>111</span>
                                </div>
                                <div class="controls_icon">
                                    <div class="controls_icon_hover"><img src="./images/icon/黑 icon/下载.png" alt="">
                                    </div>
                                    <span>111</span>
                                </div>
                            </div>
            ...
            <div class="section">
                <div class="Tutter">
                    <div class="Tutter_main">
                        ...
                        <div class="Tutter_main_content">
                            <p class="userName">陈子辉</p>
                            <p class="user_content">“FDA will not authorize or approve a vaccine that we would not feel
                                comfortable giving to our families,” FDA Commissioner Dr. Stephen Hahn says during a
                                Senate hearing. https://cnn.it/3iYHaXd</p>
                            <div class="Media">
                                <img src="./images/Avatar/Eimu2JAXcAAih-d.jpg" alt="">
                            </div>
                            <div class="controls">
                                <div class="controls_icon">
                                    <div class="controls_icon_hover"><img src="./images/icon/黑 icon/评论.png" alt="">
